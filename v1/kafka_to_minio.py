...
MINIO_BUCKET = "vtrackingsparkjson"
MINIO_PATH = "json"
...
def main():
    print("[INFO] Starting Spark job to consume from Kafka and write to MinIO (parquet, partitioned by entity_id and day)")
    ...
    # Write to MinIO in Parquet format, partitioned by entity_id and day
    print(f"[INFO] Writing to MinIO (s3a://{MINIO_BUCKET}/{MINIO_PATH}), partitioned by entity_id and day...")
